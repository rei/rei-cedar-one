export const CLASS_ALIASES: Record<string, string> = {
  abs: 'cdr-abstract',
  acc: 'cdr-accordion',
  'acc--ba': 'cdr-accordion--border-aligned',
  'acc--closed': 'cdr-accordion--closed',
  'acc--cmp': 'cdr-accordion--compact',
  'acc--ns': 'cdr-accordion--no-spacing',
  'acc--open': 'cdr-accordion--open',
  'acc--unw': 'cdr-accordion--unwrap',
  acc__btn: 'cdr-accordion__button',
  acc__cont: 'cdr-accordion__content',
  'acc__cont-wrap': 'cdr-accordion__content-container',
  acc__head: 'cdr-accordion__header',
  'acc__head--unw': 'cdr-accordion__header--unwrapped',
  acc__icon: 'cdr-accordion__icon',
  acc__lbl: 'cdr-accordion__label',
  accg: 'cdr-accordion-group',
  body: 'cdr-body',
