...
- Switched Vue docs pages to the shared Cedar One docs layout with classification badges.
...
- Added label standalone and label wrapper coverage to the lint fixture.

## 0.1.13-alpha.0 - 2026-01-31

- Added title markup coverage to the lint fixture.
...
- Added quote markup coverage to the lint fixture.
...
- Converted the Vue fixtures app into a reusable Vue library package.
- Added declaration output and export mappings for the component fixtures.
- Fixed node tsconfig emit settings to clear editor diagnostics.
- Aligned fixture styling to showcase CSS-first behavior.
