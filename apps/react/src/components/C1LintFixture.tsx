...
import type { C1InputSlots } from './input/C1Input.types';
import C1Input from './input';
    ...
    <section className="fixture">
      ...
      <section className="fixture-group">
        ...
        <div className="fixture-stack" style={{ maxWidth: '520px' }}>
          <C1Input label="Input label" slots={inputSlots} postIcons />
